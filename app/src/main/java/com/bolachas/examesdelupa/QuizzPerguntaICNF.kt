...
class QuizzPerguntaICNF : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = ConstantsICNF.getQuestions()
    ...
    override fun onClick(v: View?) {
        ...
        when(v?.id){
            ...
            R.id.btn_submit ->{
                ...
                //Cuidado que isto parece que não faz nada, mas faz. Nao apagar
